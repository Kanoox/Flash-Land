Config.Jobs.slaughterer = {
  ...
  Zones = {
    CloakRoom = {
      Pos = {x = -1071.1319580078, y = -2003.7891845703, z = 14.81551197052},
    ...
    VehicleSpawner = {
      Pos = {x = -1042.9444580078, y = -2023.2551269531, z = 12.191581993103},
      Size = {x = 1.5, y = 1.5, z = 0.6},
    ...
    VehicleDeletePoint = {
      Pos = {x = -1061.5164794922, y = -2008.3552246094, z = 12.191584854126},
      Size = {x = 1.5, y = 1.5, z = 0.6},
      Color = {r=255,g=0,b=0},
      Marker = 27,
      Blip = false,
    ...
    Delivery = {
      Pos = {x = -596.158, y = -889.324, z = 24.5373},
      Size = {x = 1.5, y = 1.5, z = 0.6},
      Color = {r = 0, g = 208, b = 255},
      Marker = 27,
      Blip = true,
