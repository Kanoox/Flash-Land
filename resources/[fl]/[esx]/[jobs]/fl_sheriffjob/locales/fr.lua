Locales['fr'] = {
  ...
  ['search_database'] = 'Consulter la base de donnée',
  ...
  ['search_database_error_not_found'] = 'le véhicule est ~y~enregistré~s~ à ~b~John Doe~s~ ~r~(CIVIL)',
  ...
  ['sheriff_stock_weapons'] = 'coffre d\'armes',
  -- Misc
