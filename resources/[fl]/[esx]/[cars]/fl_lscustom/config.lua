...
Config.Zones = {
	ls1 = {
		Pos = { x = -211.26, y = -1323.52, z = 30.40},
...
Config.ZonesMechanic = {
	ls1 = {
		Pos = vector3(-338.99890136719, -95.424507141113, 38.015697479248),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
	...
	ls2 = {
		Pos = vector3(-351.94186401367, -90.134773254395, 38.015651702881),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name = 'Los Santos Custom',
...
Config.Menus = {
	...
	modBrakes = {
		...
		parent = 'upgrades',
		modType = 12,
		price = {0.4, 0.8, 1.4, 2.0}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {1.2, 1.8, 2.2, 2.4}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {0.8, 1.3, 2.0, 2.8, 4.0}
	},
	--[[modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {50.0, 60.0, 70.0, 80.0, 105.00, 125.00}
	},]]-- Blindage
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType8	= 'B1',
		modFrontWheelsType9	= 'B2',
		modFrontWheelsType10 = 'F1',
		modFrontWheelsType11 = 'Rue',
	},
	modFrontWheelsType0 = {
		label = _U('sport'),
