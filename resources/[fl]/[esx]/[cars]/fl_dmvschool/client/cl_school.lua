...
function OpenDMVSchoolMenu()
	ESX.TriggerServerCallback('fl_dmvschool:hasAnyLicensePoint', function(hasAnyLicense)
		local ownedLicenses = {}
		...
		if not hasAnyLicense then
			table.insert(elements, {
				label = 'Récupérer son permis à point',
				value = 'get_item_license',
			})
		end
		...
		ESX.UI.Menu.Open('native', GetCurrentResourceName(), 'dmvschool_actions', {
			...
			if data.current.value == 'get_item_license' then
				TriggerServerEvent('fl_dmvschool:addLicense', 'drive')
				TriggerServerEvent('fl_dmvschool:createLicensePoint')
				ESX.UI.Menu.CloseAll()
