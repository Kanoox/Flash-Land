Locales['fr'] = {
  ...
  ['dealer_boss'] = 'Sixt - Patron',
  ['delivered'] = 'Véhicule ~g~rendu~s~ au sixt',
  ...
  ['rent_vehicle'] = 'Sixt - Véhicules en location',
  ['return_provider_menu'] = 'Sixt - Retour de véhicule',
