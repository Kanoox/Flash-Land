...
const state = {
  twitterUsername: localStorage['fl_phone_twitter_username'],
  twitterPassword: localStorage['fl_phone_twitter_password'],
  twitterAvatarUrl: localStorage['fl_phone_twitter_avatarUrl'],
  twitterNotification: localStorage['fl_phone_twitter_notif'] ? parseInt(localStorage['fl_phone_twitter_notif']) : 1,
  twitterNotificationSound: localStorage['fl_phone_twitter_notif_sound'] !== 'false',
  tweets: [],
  favoriteTweets: []
}
...
const actions = {
  ...
  twitterLogout ({ commit }) {
    localStorage.removeItem('fl_phone_twitter_username')
    localStorage.removeItem('fl_phone_twitter_password')
    localStorage.removeItem('fl_phone_twitter_avatarUrl')
  ...
  setAccount ({ commit }, data) {
    localStorage['fl_phone_twitter_username'] = data.username
    localStorage['fl_phone_twitter_password'] = data.password
    localStorage['fl_phone_twitter_avatarUrl'] = data.avatarUrl
