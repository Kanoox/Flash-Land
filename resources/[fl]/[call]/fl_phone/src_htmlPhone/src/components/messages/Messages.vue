...
<!--ESTE HTML ES ACOPLADO DEL VIEJO-->
  <div style="background: rgb(22, 22, 22);" class="phone_app messages">
    <PhoneTitle :title="displayContact" style="backgroundColor: rgb(22, 22, 22); color: rgb(22, 22, 22)" @back="quit"/> <!--:title="displayContact" :backgroundColor="color" -->
    ...
    <div id='sms_list' @contextmenu.prevent.stop="showOptions">
    ...
    <img src="/html/static/img/icons_app/photo.png" alt="logo_photo">
    <img src="/html/static/img/icons_app/gps.png" alt="logo_gps">
    ...
    <div id='sms_write' @contextmenu.prevent="showOptions">
        ...
        >
        <div style="font-size: 12px;"  class="sms_send" @click.stop="send">
...
export default {
  ...
  computed: {
    ...mapGetters(['AppsHome', 'IntlString', 'messages', 'contacts', 'useMouse', 'enableTakePhoto']),
    messagesList () {
