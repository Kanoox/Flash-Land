...
/**
 * @typedef {('success' | 'info' | 'error' | 'warning' | 'message' | 'lspd' | 'weazle' | 'emsjob')} Type
 */
...
class SimpleNotification {
     ...
     * @returns {SimpleNotification}
     */
     static lspd(content, options = {}) {
        return this.create(['gn-lspd'], content, options);
    }
     ...
     * @returns {SimpleNotification}
     */
     static weazle(content, options = {}) {
        return this.create(['gn-weazle'], content, options);
    }
     ...
     * @returns {SimpleNotification}
     */
     static emsjob(content, options = {}) {
        return this.create(['gn-emsjob'], content, options);
    }
     ...
     * @returns {SimpleNotification}
     */
     static gouv(content, options = {}) {
        return this.create(['gn-gouv'], content, options);
    }
