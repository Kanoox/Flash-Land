...
local function printError(msg)
    local errMsg = ('^1[fl_notifs Error] %s'):format(msg)
    print(errMsg)
end
...
RegisterNetEvent('fl_notifs:client:Alert')
AddEventHandler('fl_notifs:client:Alert', function(data)
    Alert({
        style = data.style,
...
RegisterNetEvent('fl_notifs:client:Custom')
AddEventHandler('fl_notifs:client:Custom', function(data)
    Custom({
        style = data.style,
        duration = data.duration,
        title = data.title,
...
RegisterNetEvent('fl_notifs:client:Image')
AddEventHandler('fl_notifs:client:Image', function(data)
    Image({
        style = data.style,
        duration = data.duration,
        title = data.title,
...
RegisterNetEvent('fl_notifs:client:Persist')
AddEventHandler('fl_notifs:client:Persist', function(data)
    Persist(data)
end)
