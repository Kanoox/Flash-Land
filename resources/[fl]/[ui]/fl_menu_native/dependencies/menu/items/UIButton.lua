        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Enabled then
                ...
                if Style.RightLabel then
                    if Style.RightLabelColor == nil then
                        Style.RightLabelColor = {R = 245, G = 245, B = 245}
                    end
                    RenderText(Style.RightLabel, CurrentMenu.X + SettingsButton.RightText.X - RightBadgeOffset + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightText.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.RightText.Scale, Active and 0 or Style.RightLabelColor.R, Active and 0 or Style.RightLabelColor.G, Active and 0 or Style.RightLabelColor.B, 255, 2)
                end
