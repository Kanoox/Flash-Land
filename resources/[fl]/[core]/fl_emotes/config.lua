...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Emotes',
        ['danceemotes'] = "🕺 Animations Danses",
        ['propemotes'] = "📦 Animations Objet",
        ['favoriteemotes'] = "🌟 Favoris",
        ['favoriteinfo'] = "Séléctionnez une animation pour la définir comme votre favori",
        ...
        ['walkingstyles'] = "Démarches",
        ['resetdef'] = "Rétablir par défaut",
        ['normalreset'] = "Normal (Réinitialiser)",
        ['moods'] = "Humeurs",
        ['infoupdate'] = "Information",
        ['infoupdateav'] = "Information (Mis à jour disponible)",
        ...
        ['notvaliddance'] = "Danse invalide.",
        ['notvalidemote'] = "Animation invalide.",
        ['nocancel'] = "No emote to cancel.",
        ['maleonly'] = "Animation réservé aux hommes, désolé !",
        ['emotemenucmd'] = "Faites / emotemenu pour ouvir le menu.",
        ['shareemotes'] = "👫 Animations partagées",
        ['shareemotesinfo'] = "Invitez une personne proche de vous pour exécuter des animations.",
        ['sharedanceemotes'] = "🕺 Dances partagées",
        ['notvalidsharedemote'] = "n'est pas une animation partagé",
        ['sentrequestto'] = "Demande envoyée à ~y~",
        ['nobodyclose'] = "Personne à proximité.",
        ['doyouwanna'] = "~y~Y~w~ pour accepter, ~r~L~w~ pour refuser (~g~",
        ['refuseemote'] = "Animation refusé.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Appuyer sur ~y~G~w~ pour utiliser le flash de l'appareil photo.",
        ['makeitrain'] = "Appuyer sur ~y~G~w~ pour jeter des billets.",
        ['pee'] = "Maintenez ~y~G~w~ pour faire pipi.",
        ['spraychamp'] = "Maintenez ~y~G~w~ pour vaporiser du champagne.",
        ['bound'] = "Bound ",
        ['to'] = "to",
  ...
  ['fr'] = {
        ...
        ['favoriteinfo'] = "Définir une animation comme favori.",
        ['rfavorite'] = "réinitialiser le favori.",
        ['prop2info'] = "❓ Les animations avec objet peuvent être situés à la fin",
        ['set'] = "Set (",
        ['setboundemote'] = ") pour être votre emote lié?",
        ['newsetemote'] = "~w~ est maintenant votre animation liée, appuyez sur ~g~CapsLock~w~ pour l'utiliser.",
        ['cancelemote'] = "Annuler l'animation",
        ['cancelemoteinfo'] = "~r~X~w~ Annule l'animation en cours de lecture",
        ...
        ['notvalidemote'] = "n'est pas une animation valide",
        ['nocancel'] = "Pas d'emote à annuler",
        ['maleonly'] = "Cette animation est réservé aux hommes, désolé!",
        ['emotemenucmd'] = "Do /emotemenu pour un menu",
        ['shareemotes'] = "👫 Animations partagées",
        ['shareemotesinfo'] = "Inviter une personne proche à effectuer une animation avec vous.",
        ['sharedanceemotes'] = "🕺 Dances partagées",
        ['notvalidsharedemote'] = "n'est pas une animation partagé valide.",
        ['sentrequestto'] = "Demande envoyée à ~g~",
        ['nobodyclose'] = "Personne assez proche.",
        ['doyouwanna'] = "~y~Y~w~ accepter, ~r~L~w~ refuser (~g~",
        ['refuseemote'] = "Animation refusée.",
        ['makenearby'] = "fait jouer le joueur à proximité",
        ['camera'] = "Appuyer sur ~y~G~w~ pour utiliser le flash de l'appareil photo.",
        ['makeitrain'] = "Maintenez ~y~G~w~ pour jeter de l'argent.",
        ['pee'] = "Maintenez ~y~G~w~ faire pipi.",
        ['spraychamp'] = "Maintenez ~y~G~w~ vaporiser du champagne.",
        ['bound'] = "Liée ",
        ['to'] = "à",
        ['currentlyboundemotes'] = " Animations actuellement liés:",
        ['notvalidkey'] = "n'est pas une clé valide.",
        ['keybinds'] = "🔢 Aide",
        ['keybindsinfo'] = "Pour sauvegarder une animation sur une touche :"
  },
  ['de'] = {
        ['emotes'] = 'Emotes',
