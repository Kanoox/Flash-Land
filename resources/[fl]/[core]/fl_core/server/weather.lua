admins = {
    'discord:304551619725361163', --- iPro
    'discord:694272896821886976', --- Loly
    'discord:424318992413491220', --- Fares
    'discord:305768794939195402',  --- Kiriose
    'discord:195274814569578506',  --- Eki
    'discord:555830077078634503',  --- ZyroK
    'discord:265939137855488000'   --- MrJekylle
}
------------------ change this -------------------
...
CurrentWeather = "EXTRASUNNY" -- EXTRASUNNY
local baseTime = 0
local timeOffset = 0
...
function NextWeatherStage()
    if CurrentWeather == "CLEAR" or CurrentWeather == "CLOUDS" or CurrentWeather == "XMAS"  then  -- EXTRASUNNY
    ...
    elseif CurrentWeather == "CLEARING" or CurrentWeather == "OVERCAST" then
        ...
        elseif new == 4 then
            CurrentWeather = "XMAS"  -- EXTRASUNNY
        elseif new == 5 then
            CurrentWeather = "SMOG"
        else
            CurrentWeather = "FOGGY"
        end
    elseif CurrentWeather == "XMAS" or CurrentWeather == "RAIN" then -- EXTRASUNNY
        CurrentWeather = "CLEARING"
