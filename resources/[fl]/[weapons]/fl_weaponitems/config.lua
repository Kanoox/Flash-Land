...
if Config.Locale == nil then Config.Locale = "en" end
...
Config.Weapons = {
  ...
  WEAPON_RAYPISTOL = { item = 'raypistol', label = _U('weapon_raypistol') },
  WEAPON_RAYCARBINE = { item = 'raycarbine', label = _U('weapon_raycarbine') },
  WEAPON_RAYMINIGUN = { item = 'rayminigun', label = _U('weapon_rayminigun') },
  WEAPON_STONE_HATCHET = { item = 'stone_hatchet', label = _U('weapon_stone_hatchet') },
  WEAPON_MUSKET = { item = 'musket', label = _U('weapon_musket') },
  WEAPON_KATANA = { item = 'katana', label = "Katana" },
  WEAPON_CERAMICPISTOL = { item = 'ceramicpistol', label = 'Pistolet céramique'},
  WEAPON_NAVYREVOLVER = { item = 'navyrevolver', label = 'Navy Revolver'},
  WEAPON_COMBATSHOTGUN = { item = 'combatshotgun', label = 'Spas 12'},
  WEAPON_GADGETPISTOL = { item = 'gadgetpistol', label = 'Pistolet Perico'},
  WEAPON_MILITARYRIFLE = { item = 'militaryrifle', label = 'Steyr AUG'},
}
