...
DoomsdayFacility = {
    ...
    PrivacyGlass = {
        ...
        Lounge = {
            Glasses = {
                {modelHash = `xm_prop_x17_l_door_glass_01`, entityHash = `xm_prop_x17_l_door_frame_01`, entityPos = {x = 359.22, y = 4846.043, z = -58.85}},
                {modelHash = `xm_prop_x17_l_door_glass_01`, entityHash = `xm_prop_x17_l_door_frame_01`, entityPos = {x = 369.066, y = 4846.273, z = -58.85}},
                {modelHash = `xm_prop_x17_l_glass_01`, entityHash = `xm_prop_x17_l_frame_01`, entityPos = {x = 358.843, y = 4845.103, z = -60.0}},
                {modelHash = `xm_prop_x17_l_glass_02`, entityHash = `xm_prop_x17_l_frame_02`, entityPos = {x = 366.309, y = 4847.281, z = -60.0}},
                {modelHash = `xm_prop_x17_l_glass_03`, entityHash = `xm_prop_x17_l_frame_03`, entityPos = {x = 371.194, y = 4841.27, z = -60.0}}
            },
            Enable = function(state)
