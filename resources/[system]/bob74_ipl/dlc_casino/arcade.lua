local InteriorID = {}
InteriorID.arcade = GetInteriorAtCoords(2730.0, -380.0, -49.0)
InteriorID.planRoom = GetInteriorAtCoords(2694.01, -362.52, -54.76)
...
for Interior,InteriorProps in pairs(propList) do
    for _,i in pairs(PropsList) do
        DisableInteriorProp(InteriorID[Interior], i)
    end
end


for Interior,InteriorProps in pairs(propList) do
    for _,InteriorProp in pairs(InteriorProps) do
        EnableInteriorProp(InteriorID[Interior], InteriorProp)
    end
    RefreshInterior(InteriorID[Interior])
end
